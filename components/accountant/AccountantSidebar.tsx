...
const navItems = [
  ...
  { name: "Fee Management", href: "/accountant/fee-management", icon: DollarSign },
  { name: "Reconciliation", href: "/accountant/reconciliation", icon: RefreshCcw },
  { name: "Outstanding Fees", href: "/accountant/outstanding", icon: AlertTriangle },
  { name: "Reports", href: "/accountant/reports", icon: FileBarChart },
      ...
      <div className="p-3 border-t border-white/10 space-y-2 shrink-0">
        ...
        <div className="flex items-center gap-4 px-3 py-3 rounded-xl bg-rose-800/50 mt-auto">
          ...
          <div className="whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75 overflow-hidden">
            ...
            <p className="text-[10px] text-white/60 uppercase">Finance Dept</p>
          </div>
        </div>
        <Link
          href="/login"
          className="flex items-center gap-4 px-3 py-3 rounded-xl text-red-200 hover:bg-red-900/30 hover:text-red-100 transition-colors"
        >
