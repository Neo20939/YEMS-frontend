...
import { getTeacherExams, createQuestion, type Exam } from "@/lib/api/exam-client"
import { BulkQuestionUploader } from "@/components/teacher/BulkQuestionUploader"
import { TheoryMarkingQueue } from "@/components/teacher/TheoryMarkingQueue"
...
export default function ExamSetupPage() {
  ...
  const [activeTab, setActiveTab] = React.useState<'create' | 'bulk' | 'marking'>('create')
  ...
  React.useEffect(() => {
    async function loadExams() {
      setIsLoading(true)
      try {
        const apiExams = await getTeacherExams()
        setExams(apiExams)
      ...
      <div className="ml-20 transition-all duration-300">
        ...
        <main className="py-8 px-6">
          <div className="max-w-6xl mx-auto">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Exam Management</h1>
              <p className="text-slate-500">Create questions, bulk upload, and mark theory exams</p>
            </div>
            ...
            {/* Exam Selector (shared across tabs) */}
            ...
            {activeTab === 'bulk' && selectedExam ? (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
                <p className="text-slate-500">Please select an exam first</p>
              </div>
            ) : null}

            {activeTab === 'marking' && (
              <div className="bg-white rounded-2xl border border-slate-200 p-6">
                <TheoryMarkingQueue examId={selectedExam || undefined} />
              </div>
            )}
          </div>
        </main>
